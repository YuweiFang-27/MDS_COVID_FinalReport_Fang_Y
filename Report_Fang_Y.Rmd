...
Completed the replication study and preliminary heatmap comparison as methodological preparation.
};

\node[process, below=of step0] (step1) {
\textbf{Step 1. China data and variable selection}\\
Selected the China survey data and identified the outcome and predictor variables required for the main analysis.
};
