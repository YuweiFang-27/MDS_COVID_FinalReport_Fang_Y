...
Figure \ref{fig:analysis-workflow} summarises the overall analysis process. Step 0 represents the replication study completed as methodological preparation. Steps 1 to 7 describe the main China analysis.
...
\node[process] (step0) {
\textbf{Step 0. Replication study}\\
Implemented the modelling workflow of Ryan et al. in Python as methodological preparation.
};
